...
export default function ReceptionistTemplate({ title, breadcrumbs = [], children }) {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-start gap-4 mb-6">
          <Link to="/reception" className="inline-flex items-center gap-2 rounded-md px-3 py-2 bg-white shadow-sm text-sm text-slate-700 hover:bg-slate-50">
